...
import contohKasusSum from "/src/assets/contoh/vlookup2.png";   
...
export default function VlookupPage() {
  ...
  return (
    <RumusTemplate
      ...
      videoUrl="https://www.youtube.com/embed/3yIP_YTwtsc"
      test={
    ...
    >
        ...
        {/* CONTOH KASUS */}
            <div className="space-y-5 w-full">
              {/* JUDUL */}
              <div>
                <h3 className="font-semibold text-lg mb-1">Menggunakan VLOOKUP dengan opsi TRUE</h3>
                <p className="text-sm text-gray-600">
                  Perhatikan contoh data barang di Excel berikut. Dalam kasus ini diminta untuk mencari harga dari tabel referensi.
                  Dimana nilai yang dicari menggunakan kode barang yang tidak identik. Rumus yang digunakan untuk mencari yaitu VLOOKUP dengan opsi True.
                </p>
              </div>
          ...
          />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between bg-indigo-50 border border-indigo-200 rounded-xl px-4 py-3 gap-2 text-center sm:text-left">
                ...
                <span className="text-lg font-bold text-indigo-700">17000</span>
              </div>
