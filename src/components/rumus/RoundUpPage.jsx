...
import RoundupImg from "/src/assets/contoh/roundup2.png";   
...
export default function RoundupPage() {
  ...
  return (
    <RumusTemplate
      title="ROUNDUP"
      functionDesc="Fungsi ROUNDUP digunakan untuk membulatkan angka ke atas (meningkatkan nilai) sesuai jumlah digit tertentu."
      usage="Gunakan ROUNDUP saat kamu ingin memastikan angka selalu dibulatkan ke atas, misalnya membulatkan nilai ujian, harga, atau angka desimal agar tidak kurang dari nilai sebenarnya."
        ...
        <div className="mt-4 space-y-6 w-full">
          ...
          <div className="p-5 space-y-4 w-full">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              ...
              Tugas kamu adalah <strong>membulatkan nilai ke atas</strong> 
              menggunakan rumus <strong>ROUNDUP</strong>.
            </p>
            <ul className="list-disc pl-5 text-sm text-gray-600 space-y-2">
              <li>Gunakan <strong>fungsi ROUNDUP</strong> (bukan manual).</li>
          ...
          {startTest && !loading && (
            <ExcelEmbed
              src="https://1drv.ms/x/c/7e81b692dc16e3ee/IQSNVQCspFJkSLdO5s687s73AVR_2yC4JlGkRdOBAN5gaSs?em=2&AllowTyping=True&ActiveCell='Sheet1'!C2&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True"
            />
          )}
        </div>
      }
    >
      ...
      <div className="space-y-5 w-full">
        {/* JUDUL */}
        <div>
          <h3 className="font-semibold text-lg mb-1">Membulatkan Angka ke Atas</h3>
          <p className="text-sm text-gray-600">
            Perhatikan contoh data di Excel berikut. Kita ingin membulatkan angka desimal ke atas sesuai jumlah digit tertentu menggunakan rumus ROUNDUP.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <img
            src={RoundupImg}
            alt="Contoh penggunaan rumus ROUNDUP di Excel"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between bg-indigo-50 border border-indigo-200 rounded-xl px-4 py-3 gap-2 text-center sm:text-left">
          ...
          <span className="text-lg font-bold text-indigo-700">3.15</span>
        </div>

        {/* CATATAN TAMBAHAN */}
        <div className="text-xs text-gray-500 leading-relaxed">
          💡 <strong>Catatan: </strong> fungsi ROUNDUP selalu membulatkan angka ke atas, berbeda dengan ROUND yang bisa ke atas atau ke bawah tergantung nilai.
        </div>
      </div>
    </RumusTemplate>
  );
