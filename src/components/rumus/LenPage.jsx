...
import contohKasusSum from "/src/assets/contoh/len2.png";   
    ...
    >
          {/* CONTOH KASUS */}
                  <div className="space-y-5 w-full">
                    {/* JUDUL */}
                    <div>
                      <h3 className="font-semibold text-lg mb-1">LEN digunakan didalam fungsi MID</h3>
                      <p className="text-sm text-gray-600">
                        Perhatikan contoh data mahasiswa di Excel berikut. Dalam kasus ini diminta untuk mengambil nama dari kolom nama file.
                        Dimana setiap nama memiliki jumlah karakter yang berbeda. Maka dengan itu 
                         rumus Mid akan di bantu dengan rumus len agar 3 karakter terakhir tidak terambil.
                      </p>
                    </div>
                ...
                />
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between bg-indigo-50 border border-indigo-200 rounded-xl px-4 py-3 gap-2 text-center sm:text-left">
                      ...
                      <span className="text-lg font-bold text-indigo-700">Rahmat</span>
                    </div>
