...
import contohKasusSum from "/src/assets/contoh/left2.png";  
...
export default function LeftPage() {
  ...
  return (
    <RumusTemplate
      title="LEFT"
      functionDesc="Fungsi LEFT digunakan untuk mengambil sejumlah karakter dari sisi kiri sebuah teks. Fungsi ini sering dipakai ketika informasi penting berada di awal data, seperti kode wilayah, kode produk, atau awalan tertentu pada teks."
      usage="Penggunaan LEFT contohnya seperti kasus ini. Kita ingin mengambil kode negara yang ada pada kode produk. Maka kita gunakan LEFT dan pilih sel yang dipakai lalu masukan angka sesuai berapa karakter yang ingin diambil."
        ...
        <div className="mt-4 space-y-6 w-full">
          ...
          <div className="p-5 space-y-4 w-full">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              ...
              Tugas kamu adalah mengambil <strong>3 karakter dari kiri dari kode produk </strong>
              menggunakan rumus <strong>LEFT</strong>.
            </p>
            <ul className="list-disc pl-5 text-sm text-gray-600 space-y-2">
              <li>Gunakan <strong>fungsi LEFT</strong> (bukan mengambil manual).</li>
          ...
          {startTest && !loading && (
            <ExcelEmbed
              src="https://1drv.ms/x/c/7e81b692dc16e3ee/IQTpuxR-NbJJTarx6aSk-MBCAVmYCS63D3p63EEPXLWGecM?em=2&AllowTyping=True&ActiveCell='Sheet1'!C2&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True"
            />
          )}
        </div>
      }
    >
      {/* CONTOH KASUS */}
        <div className="space-y-5 w-full">
          {/* JUDUL */}
          <div>
            <h3 className="font-semibold text-lg mb-1">Mengambil 7 karakter dari kiri</h3>
            <p className="text-sm text-gray-600">
              Perhatikan contoh data mahasiswa di Excel berikut. Dalam kasus ini diminta untuk mengambil nim dari kolom nama file.
              Rumus yang digunakan untuk mengambil karakter dari kiri yaitu Left.
            </p>
          </div>
      ...
      />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between bg-indigo-50 border border-indigo-200 rounded-xl px-4 py-3 gap-2 text-center sm:text-left">
            ...
            <span className="text-lg font-bold text-indigo-700">1012491</span>
          </div>
