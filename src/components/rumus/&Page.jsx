...
import contohKasusSum from "/src/assets/contoh/&2.png";   
import ExcelEmbed from "./ExcelEmbed";
import { useState } from "react";

export default function AmpersandPage() {
  ...
  return (
    <RumusTemplate
      title="& (Ampersand)"
      functionDesc="Fungsi & digunakan untuk menggabungkan teks dengan cara yang lebih sederhana dan fleksibel dibandingkan CONCATENATE."
      usage="Contoh penggunaan & diantaranya. Kita ingin  ingin menggabungkan nama depan & belakang. Maka kita gunakan fungsi & dan pilih sel nama depan dan sel nama belakang."
              ...
              <div className="mt-4 space-y-6 w-full">
                ...
                <div className="p-5 space-y-4 w-full">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ...
                    menggunakan rumus <strong>&</strong>.
                  </p>
                  <ul className="list-disc pl-5 text-sm text-gray-600 space-y-2">
                    <li>Gunakan <strong>fungsi &</strong> (bukan mengambil manual).</li>
    ...
    >
        ...
        {/* CONTOH KASUS */}
            <div className="space-y-5 w-full">
              {/* JUDUL */}
              <div>
                <h3 className="font-semibold text-lg mb-1">Mengambungkan Tiga cell</h3>
                <p className="text-sm text-gray-600">
                  Perhatikan contoh data harga barang di Excel berikut. Dalam kasus ini akan membuat kode produk yang mana isinya gabungan dari kode barang, kode tahun, dan kode negara.
      ...
      />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between bg-indigo-50 border border-indigo-200 rounded-xl px-4 py-3 gap-2 text-center sm:text-left">
                <span className="font-medium text-indigo-700">Hasil adalah</span>
                <span className="text-lg font-bold text-indigo-700">KMA2025JPN</span>
              </div>
